...
from . import views
from .views import LikeCreateDestroyView, DontMindCreateDestroyView,LearnedCreateDestroyView,LLMView,VoteCreateDestroyView,ContestDeleteView,SignUpView
...
urlpatterns = [
    ...
    path("name",SignUpView.as_view(),name="signup"),
