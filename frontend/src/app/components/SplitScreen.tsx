              ...
              <Stack spacing={4}>
                <Flex alignItems="center" mb={4} mt={6} mx={4}>
                  ...
                  <Box ml={3} bg={'gray.100'} p={3} rounded={'lg'}>
                    <Text>
                      初日からサーバーの設定をいじって、間違えて全体のデータベースを消しちゃったんです。先輩たちにすぐにバックアップを復元してもらったけど、本当に焦りました！
                    </Text>
                  </Box>
                </Flex>
                <Flex alignItems="center" justifyContent="flex-end" mb={6} mx={4}>
                  <Box mr={3} bg={'gray.100'} p={3} rounded={'lg'}>
                    <Text>
                      バックアップがあってよかったね！次回からは設定を変更する前に必ずバックアップを取る習慣をつけよう。失敗は学びのチャンスだよ！君ならもっと成長できるからね！😊
                    </Text>
                  </Box>
                  <Avatar src={'/ken.svg'} />
                </Flex>
                    ...
                    <Flex flex={1} direction="column" alignItems={'start'}>
                      ...
                      <Box>
                        <Text fontSize={14} px={2} py={1} color="black">
                          友人が英会話学校でのボランティアに参加した。生徒の一人に「What's
                          up?」と尋ねられ、彼は本気でその意味を解釈して「天井だよ！」と答えた。クラスが爆笑し、その後は「What's
                          going on?」という表現を学んだ。
                        </Text>
                      </Box>
                    </Flex>
